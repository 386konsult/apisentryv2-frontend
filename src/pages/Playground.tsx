    ...
    <div className="w-full min-h-screen bg-[#F4F8FF] dark:bg-[#0F1724] px-6 pb-10 pt-6">
      <div className="w-full space-y-6">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="rounded-2xl border border-slate-200/70 bg-white shadow-sm dark:border-slate-800/80 dark:bg-slate-900">
              ...
              <CardContent className="p-6 space-y-5">
                ...
                <div className="space-y-2">
                  <Label className="text-xs font-semibold text-slate-600 dark:text-slate-400">Headers (JSON)</Label>
                  <Textarea
                    value={headers}
                ...
                <div className="space-y-2">
                  <Label className="text-xs font-semibold text-slate-600 dark:text-slate-400">Request Body</Label>
                  <Textarea
                    value={requestBody}
              ...
              <Card className="rounded-2xl border border-slate-200/70 bg-white shadow-sm dark:border-slate-800/80 dark:bg-slate-900">
                <CardContent className="p-12 flex justify-center">
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400">Running security analysis...</p>
                  </div>
                </CardContent>
              </Card>
            )}
              ...
              <Card className="rounded-2xl border border-slate-200/70 bg-white shadow-sm dark:border-slate-800/80 dark:bg-slate-900 overflow-hidden">
                <CardHeader className="border-b border-slate-200/70 bg-gradient-to-r from-slate-50 to-transparent dark:border-slate-800/80 dark:from-slate-800/30">
                  <div className="flex items-center gap-2">
                    ...
                    <CardTitle className="text-slate-900 dark:text-white">Security Scan Response</CardTitle>
                    {testResult && (
                      <Badge
                        className={
                    ...
                    <>
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {[
                          ...
                          <div key={label} className="rounded-xl border border-slate-200/70 bg-slate-50/80 dark:border-slate-700/70 dark:bg-slate-800/30 p-3">
                      ...
                      {testResult.outcome === 'BLOCKED' && testResult.blockedBy && (
                        <div className="rounded-xl border border-red-200/70 bg-red-50/60 dark:border-red-800/30 dark:bg-red-900/10 p-4">
                          <p className="text-sm font-semibold text-red-700 dark:text-red-300 flex items-center gap-1.5 mb-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="rounded-xl border border-slate-200/70 bg-slate-950/5 dark:bg-slate-950/50 dark:border-slate-700/70 p-3 font-mono text-xs overflow-x-auto max-h-40 text-slate-700 dark:text-slate-300">
                      ...
                      <div className="space-y-4 border-t border-slate-200/70 dark:border-slate-800/80 pt-6">
                        <div className="flex items-center gap-2">
                        ...
                        {testResult.outcome === 'ERROR' ? (
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="rounded-xl border border-yellow-200/70 bg-yellow-50/60 dark:border-yellow-800/30 dark:bg-yellow-900/10 p-4">
                          ...
                          <div className="rounded-xl border border-green-200/70 bg-green-50/60 dark:border-green-800/30 dark:bg-green-900/10 p-4">
                            <div className="flex items-center gap-2 mb-2">
          ...
          {/* Right sidebar: Testing Scope, Examples, Tips */}
            ...
            <Card className="rounded-2xl border border-slate-200/70 bg-white shadow-sm dark:border-slate-800/80 dark:bg-slate-900">
              ...
              <CardContent className="p-5 space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="rounded-xl border border-slate-200/70 bg-slate-950/5 dark:bg-slate-950/50 dark:border-slate-700/70 p-2.5 font-mono text-xs break-all text-slate-700 dark:text-slate-300">
                    {fullTargetUrl || '—'}
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="rounded-2xl border border-slate-200/70 bg-white shadow-sm dark:border-slate-800/80 dark:bg-slate-900">
              ...
              <CardContent className="p-4 space-y-2">
                {exampleRequests.map((example, index) => (
                  <div
                    key={index}
                    className="rounded-xl border border-slate-200/70 bg-slate-50/60 p-3 hover:bg-blue-50/40 dark:border-slate-700/70 dark:bg-slate-800/30 dark:hover:bg-slate-800/60 transition-colors cursor-pointer group"
